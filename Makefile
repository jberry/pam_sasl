...
pkgdatadir = $(datadir)/pam_sasl
pkgincludedir = $(includedir)/pam_sasl
pkglibdir = $(libdir)/pam_sasl
pkglibexecdir = $(libexecdir)/pam_sasl
...
am__aclocal_m4_deps = $(top_srcdir)/m4/ax_prog_xsltproc.m4 \
...
am_pam_sasl_la_OBJECTS = src/pam_sasl.lo
pam_sasl_la_OBJECTS = $(am_pam_sasl_la_OBJECTS)
pam_sasl_la_LINK = $(LIBTOOL) --tag=CC $(AM_LIBTOOLFLAGS) \
	$(LIBTOOLFLAGS) --mode=link $(CCLD) $(AM_CFLAGS) $(CFLAGS) \
	$(pam_sasl_la_LDFLAGS) $(LDFLAGS) -o $@
DEFAULT_INCLUDES = -I.
...
LINK = $(LIBTOOL) --tag=CC $(AM_LIBTOOLFLAGS) $(LIBTOOLFLAGS) \
	...
	$(LDFLAGS) -o $@
SOURCES = $(pam_sasl_la_SOURCES)
DIST_SOURCES = $(pam_sasl_la_SOURCES)
man8dir = $(mandir)/man8
NROFF = nroff
MANS = $(man8_MANS)
ETAGS = etags
...
ACLOCAL = ${SHELL} /root/pam_sasl-0.1.2/missing --run aclocal-1.11
AMTAR = ${SHELL} /root/pam_sasl-0.1.2/missing --run tar
AR = ar
AUTOCONF = ${SHELL} /root/pam_sasl-0.1.2/missing --run autoconf
AUTOHEADER = ${SHELL} /root/pam_sasl-0.1.2/missing --run autoheader
AUTOMAKE = ${SHELL} /root/pam_sasl-0.1.2/missing --run automake-1.11
AWK = gawk
CC = gcc
...
LN_S = ln -s
LTLIBOBJS = 
MAKEINFO = ${SHELL} /root/pam_sasl-0.1.2/missing --run makeinfo
...
OTOOL64 = 
PACKAGE = pam_sasl
PACKAGE_BUGREPORT = xworld21@users.sf.net
PACKAGE_NAME = pam_sasl
PACKAGE_STRING = pam_sasl 0.1.2
PACKAGE_TARNAME = pam_sasl
PACKAGE_URL = http://pam-sasl.sourceforge.net/
...
XSLTPROC_FLAGS = 
abs_builddir = /root/pam_sasl-0.1.2
abs_srcdir = /root/pam_sasl-0.1.2
abs_top_builddir = /root/pam_sasl-0.1.2
abs_top_srcdir = /root/pam_sasl-0.1.2
ac_ct_CC = gcc
ac_ct_DUMPBIN = 
am__include = include
am__leading_dot = .
...
install_sh = ${SHELL} /root/pam_sasl-0.1.2/install-sh
...
src/$(DEPDIR)/$(am__dirstamp):
	@$(MKDIR_P) src/$(DEPDIR)
	@: > src/$(DEPDIR)/$(am__dirstamp)
src/pam_sasl.lo: src/$(am__dirstamp) src/$(DEPDIR)/$(am__dirstamp)
pam_sasl.la: $(pam_sasl_la_OBJECTS) $(pam_sasl_la_DEPENDENCIES) 
	$(pam_sasl_la_LINK) -rpath $(securelibdir) $(pam_sasl_la_OBJECTS) $(pam_sasl_la_LIBADD) $(LIBS)

mostlyclean-compile:
	-rm -f *.$(OBJEXT)
	-rm -f src/pam_sasl.$(OBJEXT)
	-rm -f src/pam_sasl.lo

distclean-compile:
	-rm -f *.tab.c

include src/$(DEPDIR)/pam_sasl.Plo
